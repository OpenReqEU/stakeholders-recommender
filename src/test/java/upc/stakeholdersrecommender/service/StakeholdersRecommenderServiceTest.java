...
public class StakeholdersRecommenderServiceTest {
    ...
    public void testRecommendLeftovers() throws Exception {
        ...
        List<RecommendReturnSchema> result = instance.recommend(req, k, true, "UPC",2);
        String res = mapper.writeValueAsString(result);
        String s="[{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"1\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.9131714416049265},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"254\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.7089001016936531},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"2\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.6708286047661646},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"22\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.48976899863283757},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"9\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.47784374675307056},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"142\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.46466601165341026},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"65\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.36253265934009554},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"15\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.3549471805398092},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"257\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.34047806344102166},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"245\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.3314629830126971}]\n";
        Double dist=(double) distance(s,res);
        Double percentage =dist/res.length();
        System.out.println(res);
        assertTrue(percentage<0.1);
    ...
    public void testRecommendPreprocessing() throws Exception {
        ...
        List<RecommendReturnSchema> result = instance.recommend(req, k, true, "UPC",1);
        String res = mapper.writeValueAsString(result);
        String s="[{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"22\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.9400752282419386},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"1\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.9002248313773483},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"15\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.47404961076539937},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"2\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.4636923775471894},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"38\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.3780734025886857},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"47\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.3768497100530562},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"254\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.36446071604697716},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"117\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.36311350173940615},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"142\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.3564184979749831},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"104\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.34520785541573606}]\n";
        Double dist=(double) distance(s,res);
        Double percentage =dist/res.length();
        System.out.println(res);
        assertTrue(percentage<0.1);
