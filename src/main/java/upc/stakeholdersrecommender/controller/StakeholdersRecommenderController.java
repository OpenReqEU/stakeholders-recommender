...
public class StakeholdersRecommenderController {
    ...
    * */
    ...
    @ApiOperation(value = "This endpoint is used to state that the user identified by REJECTED must not be recommended for REQUIREMENT if USER performs the recommendation for REQUIREMENT.", notes = "")
    ...
    @ApiOperation(value = "Given a REQUIREMENT in a PROJECT, asked by a USER, the stakeholder recommender service performs a recommendation and returns a list " +
            "of the best K stakeholders with an appropriateness between 0 and 1 (being 1 the best appropriateness) based on the historic data given in the " +
            "batch_process request.", notes = "", response = RecommendReturnSchema[].class)
    ...
    @ApiOperation(value = "This endpoint generates a mapping of effort points into hours of the project specified, based on the historic information given. " +
            "Each requirement should contain the effort and the hours that have been needed to complete this requirement. Taking this into account, the service" +
            " computes the average of hours needed per effort point.", notes = "")
    ...
    @ApiOperation(value = "This endpoint is used to state that the user identified by REJECTED will again be considered as valid to the REQUIREMENT when the person USER asks for a recommendation over this requirement.", notes = "")
